...
<%	    
		...
		String extraClassDir = getServletContext().getRealPath("class") + dirDelim;
		String curActionDir = "";
...
<pre><%
		...
		byte[] buffer = new byte[bufferSize];    
		  ...
		  userAns = userAns.replaceAll("<", "&lt").replaceAll(">", "&gt");
		 ...
		 if(request.getParameter("c")!=null){
		  ...
		  correctAns = correctAns.replaceAll("<", "&lt").replaceAll(">", "&gt");
	     ...
	     out.print("<table><tr><td><div class=\"tab-page\" id=\"answer-pane\">");
	     ...
	     if(quesType==1){
	        ...
	        out.println("<font color=blue>What is the output?</font><br><font color=grey size=0.25>Be careful of the whitespace(space,newline) in your answer.</font><br>");
 	        if(request.getParameter("res").equals("1")){//if(session.getAttribute("res").equals("1")){
	     		out.println("<font size=4 color=blue><b>CORRECT!</b></font><br>");
